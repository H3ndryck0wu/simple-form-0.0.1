<?php
//Formulario simple donde se capturan los datos con el metodo POST y se enviaran a la base de datos llamada "datos"
//Simple form where the data is captured with the POST method and will be sent to the database called "data"
?>
<!DOCTYPE html>
<html lang="es">
<head>
